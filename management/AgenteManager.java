...
public class AgenteManager {
    ...
    public void registrarAgente() {
        ...
        Agente nuevoAgente = new Agente(id, nombre, habilidad, id);
    ...
    public void mostrarMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("3. Mostrar Cantidad de Agentes Regristrados");
    ...
    public void mostrarCantidadAgentes() {
        if (agentes.isEmpty()) {
            System.out.println("No hay agentes registrados.");
            return;
        }
        System.out.println("Cantidad de agentes registrados: " + agentes.size());
    }

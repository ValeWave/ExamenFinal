...
public class AnomaliaManager {
    ...
    public void registrarAnomalia() {
        ...
        Anomalia nuevaAnomalia = new Anomalia(id, nombre, severidad, ubicacion, ubicacion, anomalias);
    ...
    public void mostrarMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("3. Mostrar Cantidad de Anomalías Registradas");
            ...
            switch (opcion) {
                ...
                case 3 -> mostrarCantidadAnomalias();
    ...
    public void mostrarCantidadAnomalias() {
        if (anomalias.isEmpty()) {
            System.out.println("No hay anomalías registradas.");
            return;
        }
        System.out.println("Cantidad de anomalías registradas: " + anomalias.size());
    }
